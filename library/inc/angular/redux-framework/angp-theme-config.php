...
//			add_filter('redux/options/' . $this->args['opt_name'] . '/sections', array($this, 'dynamic_section'));
		...
		public function setSections() {
			...
			/*$this->sections[] = array(
				'icon' => 'el-icon-bullhorn',
				'title' => __('Login options', 'redux-framework-demo'),
				'heading' => __('Admin login options.', 'redux-framework-demo'),
				'desc' => __('<p class="description">The "hide backend" feature changes the URL from which you can access your WordPress backend thereby further obscuring your site to potential attackers. If you want to hide your login, registration and wp-admin path change it here first</p>', 'redux-framework-demo'),
				'fields' => array(
					...
					array(
						'id' => 'opt-text-login-slug',
						'type' => 'text',
						'title' => __('Login Slug', 'redux-framework-demo'),
						'subtitle' => __('You decide.', 'redux-framework-demo'),
						'desc' => __('
Ex. Url: http://angularpress.localhost/<span style="color:#35cc15">login</span>'),
						'validate' => 'preg_replace',
						'preg' => array(
							'pattern' => '/[^a-zA-Z_ -]/s',
							'replacement' => 'no numbers'
					...
					array(
						'id' => 'opt-text-register-slug',
						'type' => 'text',
						'title' => __('Register Slug', 'redux-framework-demo'),
						'subtitle' => __('You decide.', 'redux-framework-demo'),
						'desc' => __('
Ex. Url: http://angularpress.localhost/<span style="color:#35cc15">register</span>'),
						'validate' => 'preg_replace',
						'preg' => array(
							'pattern' => '/[^a-zA-Z_ -]/s',
							'replacement' => 'no numbers'
					...
					array(
						'id' => 'opt-text-admin-slug',
						'type' => 'text',
						'title' => __('Admin Slug', 'redux-framework-demo'),
						'subtitle' => __('You decide.', 'redux-framework-demo'),
						'desc' => __('
Ex. Url: http://angularpress.localhost/<span style="color:#35cc15">admin</span>'),
						'validate' => 'preg_replace',
						'preg' => array(
							'pattern' => '/[^a-zA-Z_ -]/s',
							'replacement' => 'no numbers'
					...
					array(
						'id' => 'opt-text-secret-key',
						'type' => 'text',
						'title' => __('key', 'redux-framework-demo'),
						'subtitle' => __('Your secret key.', 'redux-framework-demo'),
						'desc' => __('If you use a secret key write it here'),
						'validate' => 'str_replace',
						'str' => array(
							'search' => ' ',
							'replacement' => 'thisisaspace'
		...
		public function setArguments() {
			...
			$this->args = array(
				...
				'opt_name' => 'angularpress_option', // This is where your data is stored in the database and also becomes your global variable name.
